...
export CIVIC_ENTITY_SHORT_NAME="Avritt"

# REQUIRED
# The full name for the civic entity. Ex. "City of Rochester"
export CIVIC_ENTITY_FULL_NAME="City of Avritt"

# REQUIRED
# The email address to contact for support with using Civiform. Ex. "Civiform@CityOfRochester.gov
export CIVIC_ENTITY_SUPPORT_EMAIL_ADDRESS="avritt+civiform-support@google.com"
...
export SENDER_EMAIL_ADDRESS="avritt@civiform.dev"
...
export STAGING_PROGRAM_ADMIN_NOTIFICATION_MAILING_LIST="avritt+civiform-pa@google.com"

# REQUIRED
# The email address that receives a notifications email each time an applicant
# submits an application to a program in the staging environments, instead of
# sending it to the trusted intermediary's email, as would happen in prod.
export STAGING_TI_NOTIFICATION_MAILING_LIST="avritt+civiform-ti@google.com"

# REQUIRED
# The email address that receives a notifications email each time an applicant
# submits an application to a program in the staging environments, instead of
# sending it to the applicant's email, as would happen in prod.
export STAGING_APPLICANT_NOTIFICATION_MAILING_LIST="avritt+civiform-applicant@google.com"
...
export APP_PREFIX="avritt-dev" # max 19 chars, only numbers, letters, dashes, and underscores
